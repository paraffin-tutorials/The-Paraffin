...
if (author !== null && timeout - (Date.now() - author) > 0) {
    ...
    .setColor("#f2ecec")
    .setDescription(`شما همین الان طلا خریداری کردید و طلا فروشی برای شما تا ${time.hours}h ${time.minutes}m ${time.seconds}s ساعت دیگر بسته است   **|** <:x_:778316309050032149>    `);
    
    message.channel.send(timeEmbed)
  } else {
let moneyEmbed2 = new Discord.MessageEmbed()
.setColor("#f2ecec")
.setDescription(`شما حداقل نیاز به **.${resp}.** پیکوین برای خرید **.${args[0]}.**گرم طلا دارید  **|** <:x_:778316309050032149>    `)
